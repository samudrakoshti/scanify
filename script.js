...
function login() {
  ...
  // Trigger a custom event so our inline Firebase script in index.html can catch it
  const loginEvent = new CustomEvent('userLoginAttempt', { detail: { email, password } });
